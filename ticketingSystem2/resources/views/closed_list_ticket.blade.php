        ...
        <div class="col-md-10">
            <table class="table table-bordered table-hover" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $closed_ticket->ticket_code }}</td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary" onclick="window.location='{{ url("/logs_page/$closed_ticket->ticket_code") }}'">Logs</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="modal-body">
          <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                ...
                <!--LOGS-->
                    ...
                    <input type="hidden" class="form-control" id="reopen_logs" name='inprogress' value="Admin Reopen this Ticket" disabled >
                <!-------->

                <!-------FOR NOTIFICATION-------->
                    <input type="hidden" class="form-control" id="notif_name" name='reopen' value="{{ Auth::user()->name }}(admin)" disabled >
                    <input type="hidden" class="form-control" id="texttext" name='reopen' value="Reopen this ticket" disabled >
                <!------------------------------->
        </div>
