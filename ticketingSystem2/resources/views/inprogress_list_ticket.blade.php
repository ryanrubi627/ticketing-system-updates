        ...
        <div class="col-md-10">
            <table class="table table-bordered table-hover" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $inprogress_ticket->ticket_code }}</td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary" onclick="window.location='{{ url("/logs_page/$inprogress_ticket->ticket_code") }}'">Logs</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="modal-body">
          <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                ...
                <!--LOGS-->
                    ...
                    <input type="hidden" class="form-control" id="closed_logs" name='inprogress' value="Admin Closed this Ticket" disabled >
                <!-------->
        </div>
        <div class="modal-footer">
          <input type = 'submit' class="btn btn-primary" value = "Closed" id="sbmt-closed-tckt">
          <!-------FOR NOTIFICATION-------->
          <input type="hidden" class="form-control" id="texttext" name='reopen' value="Closed this ticket" disabled >
